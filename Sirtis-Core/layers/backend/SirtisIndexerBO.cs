...
namespace SirtisIndexer.layers.backend
{
    public class SirtisIndexerBO
    {
        ...
        List<string> strAutoCompleteSource;
        #endregion
        ...
        public IndexedFolder ProcessFolderSync(string p_strPath)
        {
            ...
            try
            {
                ...
                foreach (string file in strFiles)
                {
                    ...
                    {
                        objIndexedFolder.Files.Add(objAuxIndexer.ProcessFile(file));
        ...
        public IndexedFolder IndexedFolder { get => objIndexedFolder; }
        public List<string> AutoCompleteSource { get => strAutoCompleteSource; }
        #endregion
